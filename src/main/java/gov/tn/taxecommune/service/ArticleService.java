...
//	private RoleService roleService;
	...
	public ArticleService(ArticleRepository articleRepository, RueService rueService,
			TypeActivitéService typeActivitéService, ArticleTypeActivitéService articleTypeActivitéService,
	...
	public Optional<Article> findByNumeroMunicipal(long numeroMunicipal) {
	...
	public Page<Article> findByNumeroMunicipalPageable(long numeroMunicipal, Pageable pageRequest) {
	...
	// region Find eagerly
	public Article findByNumeroMunicipalEagerly(Long numeroMunicipal) {
...
//	}
	...
	public Article createNewArticle(ArticleDto articleTclDto) {
		...
		long numMunicipal = Long.parseLong(articleTclDto.getNumeroMunicipal());
...
//        user.setRoles(Collections.singletonList(roleService.findByName("ROLE_USER")));
	...
	public Article createNewArticleTib(ArticleTibDto articleTclDto) {
		...
		try {
			findByNumeroMunicipal(Long.parseLong(articleTclDto.getNumeroMunicipal())).get();
			article.setNumeroMunicipal(Long.parseLong(articleTclDto.getNumeroMunicipal()));
