 ...
 */
public class DoubleNumericFieldValidator implements ConstraintValidator<ValidDoubleNumericField, String> {
    private Pattern pattern;
    private Matcher matcher;
    private static final String NUMCHAMP_PATTERN = "^([0-9]{2})$";
    @Override
    public void initialize(ValidDoubleNumericField constraintAnnotation) {
    }
    @Override
